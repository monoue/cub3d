...
int		calc_current_location_in_image_buf(int x, int y,
...
void	set_color_element(unsigned char *image_buf,
...
void	set_current_pixel(unsigned char *image_buf, const int image_size,
																int x, int y)
{
...
void	write_header(int fd, const unsigned int image_size)
{
	...
	// line_size = g_cubfile_data.window_width * 4;
	// image_size = g_cubfile_data.window_height * line_size;
