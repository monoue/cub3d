...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/21 13:11:09 by monoue            #+#    #+#             */
/*   Updated: 2020/11/21 13:11:10 by monoue           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef RAY_TO_SPRITE_H
# define RAY_TO_SPRITE_H
...
typedef struct	s_ray_to_sprite_materials {
	...
	float	hit_distance;
}				t_ray_to_sprite_materials;

extern t_ray_to_sprite	g_rays_to_sprite[MAX_WINDOW_WIDTH];
