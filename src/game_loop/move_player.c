...
/*   Updated: 2020/11/27 15:44:00 by monoue           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			move_player(void)
{
	...
	if (g_player.walk_direction != NEUTRAL)
	{
		...
		if (!map_has_collision_objection_at(new_player_x, g_player.y))
			g_player.x = new_player_x;
		if (!map_has_collision_objection_at(g_player.x, new_player_y))
